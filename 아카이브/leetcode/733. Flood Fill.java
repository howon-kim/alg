/**
 * 733. Flood Fill | Easy | 20 Min
 * https://leetcode.com/problems/flood-fill/
 *
 * Performance
 * Runtime: 1 ms, faster than 85.73% of Java online submissions for Flood Fill.
 * Memory Usage: 43.3 MB, less than 57.89% of Java online submissions for Flood Fill.
 *
 * Description
...
class Solution {
    ...
    public int[][] helper(int[][] image, int sr, int sc, int newColor, int oldColor) {
